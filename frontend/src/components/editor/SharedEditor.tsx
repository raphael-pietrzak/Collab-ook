...
function SharedEditor({ selectedChapter }: { selectedChapter: { id: string, content: string } }) {
  ...
  useEffect(() => {
    ...
    const provider = new WebsocketProvider(
      'wss://demos.yjs.dev',
      `demo-document-${selectedChapter.id}`,
      ydoc
    );
    ...
    editorElement.textContent = selectedChapter.content;
